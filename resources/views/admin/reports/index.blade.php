...
<div class="card shadow-sm border-0 mb-4 stagger-1" style="border-radius:var(--radius-lg);">
    <div class="card-header bg-white p-4 border-bottom border-light d-flex flex-wrap align-items-center gap-2">
        <h5 class="fw-bold mb-0 text-dark d-flex align-items-center me-auto">
        ...
        <div class="d-flex align-items-center gap-2">
            ...
            <button type="button" onclick="exportData('pdf')" class="btn btn-danger px-3 py-2 fw-bold rounded-3 d-inline-flex align-items-center gap-2" style="font-size:13px; box-shadow:0 4px 10px rgba(230,57,70,0.2);">
