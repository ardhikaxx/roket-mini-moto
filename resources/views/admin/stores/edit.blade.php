...
@section('content')
<h2 class="fw-bold mb-4">Edit Toko: {{ $store->name }}</h2>
    ...
    <form action="{{ route('admin.stores.update', $store->id) }}" method="POST">
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <input type="text" name="code" class="form-control" required value="{{ old('code', $store->code) }}">
            </div>
            <div class="col-md-6 mb-3">
                <label>Nama Toko <span class="text-danger">*</span></label>
                <input type="text" name="name" class="form-control" required value="{{ old('name', $store->name) }}">
            </div>
            ...
            <div class="col-md-12 mb-3">
                <div class="form-check form-switch">
                  <input class="form-check-input" type="checkbox" name="is_active" id="is_active" value="1" {{ $store->is_active ? 'checked' : '' }}>
