    ...
    <div class="col-12 col-lg-4">
        ...
        <div class="card shadow-sm border-0 mb-4" style="border-radius:var(--radius-lg); overflow:hidden;">
            ...
            <div style="width:100%; height:240px; background:var(--neutral-100); position:relative; overflow:hidden;">
                <img src="{{ $store->photo ? asset('storage/'.$store->photo) : asset('assets/images/no-image.png') }}" alt="{{ $store->name }}" style="width:100%; height:100%; object-fit:cover;" onerror="this.onerror=null;this.src='{{ asset('assets/images/no-image.png') }}';">
            </div>
