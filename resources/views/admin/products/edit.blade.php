                    ...
                    <div class="form-row mb-4">
                        <div class="form-group mb-0">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="price" class="form-control border-start-0 ps-0 @error('price') is-invalid @enderror" required min="0" value="{{ old('price', $product->price) }}" placeholder="0">
                            </div>
                        ...
                        <div class="form-group mb-0">
                            ...
                            <div class="input-group">
                                <span class="input-group-text bg-light border-end-0">Rp</span>
                                <input type="number" name="cost_price" class="form-control border-start-0 ps-0 @error('cost_price') is-invalid @enderror" min="0" value="{{ old('cost_price', $product->cost_price) }}" placeholder="0">
                            </div>
