                    ...
                    <div class="form-row mb-4">
                        <div class="form-group mb-0">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="price" inputmode="numeric" class="form-control input-rupiah border-start-0 @error('price') is-invalid @enderror" required value="{{ old('price', number_format($product->price, 0, ',', '.')) }}" placeholder="0">
                            </div>
                        ...
                        <div class="form-group mb-0">
                            ...
                            <div class="input-group">
                                <span class="input-group-text bg-light border-end-0">Rp</span>
                                <input type="text" name="cost_price" inputmode="numeric" class="form-control input-rupiah border-start-0 @error('cost_price') is-invalid @enderror" value="{{ old('cost_price', $product->cost_price ? number_format($product->cost_price, 0, ',', '.') : '') }}" placeholder="0">
                            </div>
